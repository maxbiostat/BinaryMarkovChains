...
#' true.alpha <- .02
#' true.beta <- .2
#' mat <- abs(matrix(c(1-true.alpha, true.alpha, true.beta, 1-true.beta), ncol = 2, nrow = 2, byrow = TRUE))
#' MC.binary <- new("markovchain", states = c("0", "1"), transitionMatrix = mat, name = "Binary")
#' M <- 1E4
